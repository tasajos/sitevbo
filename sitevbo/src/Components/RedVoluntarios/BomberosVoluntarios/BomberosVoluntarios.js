// src/Components/RedVoluntarios/BomberosVoluntarios/BomberosVoluntarios.js
...
import './BomberosVoluntarios.css';

const BomberosVoluntarios = () => {
    const [unidades, setUnidades] = useState([]);
    const [filtro, setFiltro] = useState('');

    useEffect(() => {
        const unidadesRef = ref(database, '/epr');
...
export default BomberosVoluntarios;
